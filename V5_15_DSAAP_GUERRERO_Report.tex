...
% - - - - - - - - - - - -  - - - - - - - - - - - - - - - - - - - - - - - - %
%\newpage
%\input{sections/0_nomenclature.tex}
\clearpage
\pagestyle{plain}
\setcounter{page}{1}
...
\input{sections/1_goal}
\input{sections/2_languages}
\input{sections/3_workflow}
\input{sections/4_development_setup}
\input{sections/5_testing_coverage}
...
\newpage
\appendix
\input{sections/9_apppendix.tex}

%%\include{sections/99_references} 
